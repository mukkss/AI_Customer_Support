...
# from my_app.agent.utils.nodes.product_retrieval import product_retrieval_node
...
def build_graph():
    ...
    # graph.add_node("product_retrieval", product_retrieval_node)
    ...
    # graph.add_edge("product_retrieval", "supervisor_post")
